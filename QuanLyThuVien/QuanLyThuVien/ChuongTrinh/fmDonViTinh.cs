...
{
    public partial class fmDonViTinh : UserControl
    {
        public fmDonViTinh()
        {
            InitializeComponent();
        ...
        Int16 TrangThai = 0;
        Decimal Ma = 0;
        clDonViTinh clDonViTinh = new clDonViTinh();
        clDonViTinh ojp = new clDonViTinh();
        private void fmDonViTinh_Load(object sender, EventArgs e)
        {
            Ham.ThemLuocSu(Ham.MaNV, "Đơn vị tính", "Xem", "");
        ...
        private void gridView1_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            ...
            bntXoa.Enabled = true;
            Ma = Convert.ToDecimal(a.Replace("DVT00", ""));
            if (TrangThai == 2)
                this.LoadTxt();
        ...
        private void LoadGV()
        {
            gridControl1.DataSource = clDonViTinh.LayDS();
            gridView1.GroupPanelText = "Tổng số dòng là: " + clDonViTinh.Dem();

        }
        private void LoadTxt()
        {
            ojp = clDonViTinh.LayDS_Ma(Ma);
            txtTen.Text = ojp.TenDVT;
        ...
        private void Them()
        {
            ...
            clDonViTinh.TenDVT = txtTen.Text;
            clDonViTinh.GhiChu = txtGhiChu.Text;
            clDonViTinh.TrangThai = cbTrangThai.Checked;
            if (clDonViTinh.Them(clDonViTinh) > 0)
            {
                Ham.KhungTB(1, "Thêm thành công", pnThongBao, lbThongBao);
                Ham.ThemLuocSu(Ham.MaNV, "Thêm đơn vi tính: " + txtTen.Text, "Thêm", "");
            }
            else
        ...
        private void Sua()
        {
            ...
            clDonViTinh.TenDVT = txtTen.Text;
            clDonViTinh.MaDVT = Ma; 
            clDonViTinh.GhiChu = txtGhiChu.Text;
            clDonViTinh.TrangThai = cbTrangThai.Checked;
            if (clDonViTinh.Sua(clDonViTinh) == true)
            {
                Ham.KhungTB(1, "Thay đổi thành công", pnThongBao, lbThongBao);
                Ham.ThemLuocSu(Ham.MaNV, "Thay đổi đơn vi tính " + Ma + " thành: " + txtTen.Text, "Thay đổi", "");
            }
            else
