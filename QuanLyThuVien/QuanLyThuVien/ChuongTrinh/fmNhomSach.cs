...
{
    public partial class fmNhomSach : UserControl
    {
        public fmNhomSach()
        {
            InitializeComponent();
        ...
        Int16 TrangThai = 0;
        Decimal Ma = 0;
        clNhomSach clNhomSach = new clNhomSach();
        clNhomSach ojp = new clNhomSach();

        private void fmNhomSach_Load(object sender, EventArgs e)
        {
            Ham.ThemLuocSu(Ham.MaNV, "Nhóm Sách", "Xem", "");
        ...
        private void gridView1_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            ...
            bntXoa.Enabled = true;
            Ma = Convert.ToDecimal(a.Replace("NS00", ""));
            if (TrangThai == 2)
                this.LoadTxt();
        }
        private void LoadGV()
        {
            gridControl1.DataSource = clNhomSach.LayDS();
            gridView1.GroupPanelText = "Tổng số dòng là: " + clNhomSach.Dem();

        }
        private void LoadTxt()
        {
            ojp = clNhomSach.LayDS_Ma(Ma);
            txtTen.Text = ojp.TenNS;
        ...
        private void Them()
        {
            ...
            clNhomSach.TenNS = txtTen.Text;
            clNhomSach.GhiChu = txtGhiChu.Text;
            clNhomSach.TrangThai = cbTrangThai.Checked;
            if (clNhomSach.Them(clNhomSach) > 0)
            {
                Ham.KhungTB(1, "Thêm thành công", pnThongBao, lbThongBao);//
                Ham.ThemLuocSu(Ham.MaNV, "Thêm nhóm sách: " + txtTen.Text, "Thêm", "");
            }
            else
        ...
        private void Sua()
        {
            ...
            clNhomSach.GhiChu = txtGhiChu.Text;
            clNhomSach.TrangThai = cbTrangThai.Checked;
            if (clNhomSach.Sua(clNhomSach) == true)
            {
                Ham.KhungTB(1, "Thay đổi thành công", pnThongBao, lbThongBao);//
                Ham.ThemLuocSu(Ham.MaNV, "Thay đổi nhóm sách " + Ma + " thành: " + txtTen.Text, "Thay đổi", "");
            }
            else
