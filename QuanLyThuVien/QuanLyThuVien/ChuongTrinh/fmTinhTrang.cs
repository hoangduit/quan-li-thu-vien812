...
{
    public partial class fmTinhTrang : UserControl
    {
        public fmTinhTrang()
        {
            InitializeComponent();
        ...
        Int16 TrangThai = 0;
        Decimal Ma = 0;
        clTinhTrang clTinhTrang = new clTinhTrang();
        clTinhTrang ojp = new clTinhTrang();
        private void fmTinhTrang_Load(object sender, EventArgs e)
        {
            Ham.ThemLuocSu(Ham.MaNV, "Tình Trạng Sách", "Xem", "");
        ...
        private void bntLuu_Click(object sender, EventArgs e)
        {
            if (txtTen.Text == "")
            {
                Ham.KhungTB(3, "Tên tình trạng không được rổng", pnThongBao, lbThongBao);//
                txtTen.Focus();
                return;
            }
            if (TrangThai == 1)
        ...
        private void gridView1_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            ...
            bntXoa.Enabled = true;
            Ma = Convert.ToDecimal(a.Replace("TTr00", ""));
            if (TrangThai == 2)
                this.LoadTxt();
        }
        private void LoadGV()
        {
            gridControl1.DataSource = clTinhTrang.LayDS();
            gridView1.GroupPanelText = "Tổng số dòng là: " + clTinhTrang.Dem();

        }
        private void LoadTxt()
        {
            ojp = clTinhTrang.LayDS_Ma(Ma);
            txtTen.Text = ojp.TenTTS;
        ...
        private void Them()
        {
            ...
            clTinhTrang.TenTTS = txtTen.Text;
            clTinhTrang.GhiChu = txtGhiChu.Text;
            clTinhTrang.TrangThai = cbTrangThai.Checked;
            if (clTinhTrang.Them(clTinhTrang) > 0)
            {
                Ham.KhungTB(1, "Thêm thành công", pnThongBao, lbThongBao);//
                Ham.ThemLuocSu(Ham.MaNV, "Thêm tình trạng: " + txtTen.Text, "Thêm", "");
            }
            else
        ...
        private void Sua()
        {
            ...
            clTinhTrang.TenTTS = txtTen.Text;
            clTinhTrang.MaTTS = Ma;
            clTinhTrang.GhiChu = txtGhiChu.Text;
            clTinhTrang.TrangThai = cbTrangThai.Checked;
            if (clTinhTrang.Sua(clTinhTrang) == true)
            {
                Ham.KhungTB(1, "Thay đổi thành công", pnThongBao, lbThongBao);//
                Ham.ThemLuocSu(Ham.MaNV, "Thay đổi tình trạng " + Ma + " thành: " + txtTen.Text, "Thay đổi", "");
            }
            else
